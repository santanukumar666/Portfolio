        ...
        <Row className="resume">
          <Col md={6} className="resume-left">
            ...
            <Resumecontent
              ...
              content={[
                "• Worked on a customized ZYNQ Board to automate its testing and fixed bugs in the code which writes into the EEPROMs and then reads back using i2c tools.<br>• The automation reduced the testing time by 30 %."
              ]}
            />
